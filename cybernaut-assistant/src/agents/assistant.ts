...
import projectQaReportSkill from '../../../server/workspace/.agents/skills/generate-project-qa-report/SKILL.md' with { type: 'skill' };
...
export default defineAgent(() => ({
  ...
  skills: [advisorySkill, projectQaReportSkill, investmentDdReportSkill],
  instructions: [
