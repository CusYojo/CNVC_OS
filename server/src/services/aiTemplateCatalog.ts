...
export const AI_TEMPLATE_CATALOG: Record<AiBusinessTaskType, AiTemplateDefinition> = {
  compliance_statement: {
    ...
    outputFormat: 'docx',
    templateVersion: 'compliance-deita-20260701-v2',
  ...
  investment_proposal: {
    ...
    outputFormat: 'docx',
    templateVersion: 'proposal-jialiang-20260622-v2',
  ...
  due_diligence_report: {
    ...
    outputFormat: 'docx',
    templateVersion: 'dd-jialiang-202606-v2',
...
export const AI_QA_TEMPLATE: AiQaTemplateDefinition = {
  ...
  skillName: 'answer-project-qa',
  label: '项目 Q&A',
  templateVersion: 'qa-docs-samples-202607-v2',
  referencePaths: [
