...
12. 中文与相邻英文单词或英文缩写之间不留空格，如“AI医疗”“FDE团队”；英文短语内部的正常空格保留。
...
14. sections 必须且只能按指定顺序返回：${group.sections.join('、')}。
...
中文与相邻英文单词或英文缩写之间不留空格，如“AI医疗”“FDE团队”；英文短语内部的正常空格保留。
...
28. 中文与相邻英文单词或英文缩写之间不留空格，如“AI医疗”“FDE团队”；英文短语内部的正常空格保留。`
    : ''
