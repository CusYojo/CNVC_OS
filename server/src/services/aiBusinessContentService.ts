...
执行摘要通常用 2–6 个完整句子、160–420 个汉字，篇幅随事实密度变化。先写最能支撑判断的公司、产品、客户、经营、财务或交易事实，再自然交代投资价值、主要制约和关键条件。严禁出现“线索阶段、进入初筛、申请立项、启动尽调、提请上会、提交投决、继续跟踪、暂缓推进、归档”等内部项目流程词；不得单独写没有事实支撑的阶段判断。
