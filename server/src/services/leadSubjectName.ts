...
const PREDICATE_RE = /(?:要求|适应|指出|表示|强调|认为|提出|推动|支持|开展|引导|走出|打造|落地|实现|完成|获得|发布|宣布|拟|提供|形成|建立|构建|促进|提升|加强|记录|证明|担任|任职|毕业|来自|师从|进入|共享|梳理|发表|结合|参与|经历|合作者|申请|接受|走访|到访|举办|发言|带队|来到|组建|体会|体会到了?|感受到|意识到|认识到|学到|了解到)/
