...
const REQUIRED_RUNTIME_TABLES = [
  ...
  'lead_topic_search_cache', 'lead_fact_evidence', 'lead_fact_conflicts', 'lead_enrichment_snapshots',
  'lead_institution_dictionary', 'lead_customer_dictionary', 'lead_industry_dictionary',
  'lead_academic_institution_dictionary', 'lead_investment_profile_projections', 'lead_research_profile_projections', 'lead_rating_history',
