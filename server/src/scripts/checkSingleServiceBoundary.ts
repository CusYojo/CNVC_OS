...
async function main() {
  ...
  requireCondition(
    ...
    && /"packageCount": 11/.test(documentRuntimeDependencyManifest)
    && /"linux": \["python", "libreOffice", "popplerRasterizer", "popplerFonts", "tesseract", "fontconfig"\]/.test(documentRuntimeDependencyManifest)
