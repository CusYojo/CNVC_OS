...
- Run `python3 "${CLAUDE_SKILL_DIR}/scripts/investment_bank_styles.py" audit` after formatting. Missing
...
- Run `python3 "${CLAUDE_SKILL_DIR}/scripts/investment_bank_styles.py" audit` after formatting. Mixed table
