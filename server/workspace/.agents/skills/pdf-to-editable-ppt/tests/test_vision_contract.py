...
from convert_pdf import visual_qa_gate  # noqa: E402
...
class VisionContractTests(unittest.TestCase):
    ...
    def test_off_mode_placeholder_cannot_mask_pending_agent_qa(self):
        self.assertFalse(visual_qa_gate("off", True, True))
        self.assertTrue(visual_qa_gate("off", False, True))
        self.assertFalse(visual_qa_gate("required", False, False))
