...
export function CollaborationPage() {
  ...
  return <div className="fde-collaboration-page" key={userId}>
    <header className="fde-page-heading"><div><h1>协同中心</h1></div></header>
